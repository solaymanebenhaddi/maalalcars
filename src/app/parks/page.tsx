...
import { createParkAction } from './actions'
      ...
      {isAddingPark && (
        <div className="rounded-2xl border border-red-500/30 bg-[#121216] p-6 shadow-2xl space-y-4 animate-in fade-in">
          ...
          <form action={createParkAction} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 text-xs">
            ...
            <div>
              <label className="block text-xs font-semibold text-zinc-300 mb-1">Adresse Physique</label>
              <input
                type="text"
                name="address"
                placeholder="Ex: Boulevard Mohamed VI..."
                className="h-9 w-full rounded-lg border border-[#282834] bg-[#16161c] px-3 text-xs text-white focus:border-red-500 focus:outline-none"
              />
            </div>
            ...
            <div>
              <label className="block text-xs font-semibold text-zinc-300 mb-1">Capacité Maximale (Voitures)</label>
              <input
                type="number"
                name="capacity"
                defaultValue={30}
            ...
            >
              ...
              <div className="flex items-center justify-between gap-3 pt-2 border-t border-[#222228]">
                ...
                <Link
                  ...
                  className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-lg bg-red-600/10 border border-red-500/30 text-red-400 hover:bg-red-600 hover:text-white text-xs font-bold transition-all ml-auto"
                >
