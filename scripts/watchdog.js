 ...
 *   */5 * * * * /usr/bin/node /home/YOUR_CPANEL_USER/maalalcars/scripts/watchdog.js >> /home/YOUR_CPANEL_USER/maalalcars/watchdog.log 2>&1
 * 
 * How it works:
...
function getNodeProcesses() {
  try {
    ...
    return output
      ...
      .filter((p) => p.comm === 'node' || p.comm === 'nodejs' || p.args.includes('node'));
  } catch (e) {
